...
vid_path="/home/cc/code/facedocs/assets/istiklal1.mp4"
...
server = NetGear(address='192.168.196.80', port='5454', protocol='tcp', pattern=0, receive_mode=False, logging=True,
